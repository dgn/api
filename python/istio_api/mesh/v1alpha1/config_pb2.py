...
_MESHCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='authn_jwks_use_default_root_ca', full_name='istio.mesh.v1alpha1.MeshConfig.authn_jwks_use_default_root_ca', index=39,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='authn_jwks_custom_root_ca', full_name='istio.mesh.v1alpha1.MeshConfig.authn_jwks_custom_root_ca', index=40,
